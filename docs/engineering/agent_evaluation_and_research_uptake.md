...
For the historical KA/KCAP/common-sense KR/scientific KR uptake pass that proposes
new Vontology tooling surfaces, see
[historical Vontology tooling research review](https://github.com/Strong-AI-Lab/Von/blob/5b2f8b976069935da73b82bca433fb3cefffcd3d/docs/engineering/vontology_tooling_from_ka_kcap_kr_literature.md). Use it as a
