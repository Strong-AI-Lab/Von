...
7. `P2`: `JVNAUTOSCI-1583` and `JVNAUTOSCI-1584`: add source-authority purity gates and Vontology-authored snapshot/diff tooling so the stronger authority model is easier to preserve.
