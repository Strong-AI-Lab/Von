...
| [Knowledge federation pilot](engineering/knowledge_federation_pilot.md) | Bounded implementation and authority contract | JVNAUTOSCI-2730: opt-in complete-slice exchange between independent stores; source audiences, atomic receipt/read projection, expiry, recovery and later SC448086 admission. Not general database replication or execution federation. |
