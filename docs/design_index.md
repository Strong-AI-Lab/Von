...
| [Ontology publication authority](engineering/ontology_publication_authority.md) | Active design/implementation boundary | Operational reference for `JVNAUTOSCI-2632`; distinguish semantic publication from visibility and operational administration, and revalidate the current runtime and represented roles before relying on deployment-specific claims |
