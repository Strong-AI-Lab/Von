...
This module intentionally does not contain lexical or language-specific
fallback guidance. If no learned policy snapshot is available, Python must not
steer selector semantics; the selector LLM and represented authority surfaces
remain responsible for the content-level choice.
"""
