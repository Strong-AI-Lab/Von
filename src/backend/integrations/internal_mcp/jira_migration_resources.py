...
RESOURCES = {
    ...
    "screen_tabs": ("api/3", "screens/{id}/tabs", False),
    "screen_tab_fields": ("api/3", "screens/{id}/tabs/{secondary}/fields", False),
    "screen_schemes": ("api/3", "screenscheme", True),
    "issue_type_screen_schemes": ("api/3", "issuetypescreenscheme", True),
    "issue_type_screen_mappings": ("api/3", "issuetypescreenscheme/mapping", True),
    "issue_type_schemes": ("api/3", "issuetypescheme", True),
    "issue_type_scheme_items": ("api/3", "issuetypescheme/mapping", True),
    "field_configurations": ("api/3", "fieldconfiguration", True),
    "field_configuration_items": ("api/3", "fieldconfiguration/{id}/fields", True),
    "field_configuration_schemes": ("api/3", "fieldconfigurationscheme", True),
    "field_configuration_mappings": ("api/3", "fieldconfigurationscheme/mapping", True),
