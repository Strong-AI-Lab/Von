...
PERSON_FILE_COPY_RETIRED_SYMBOLS = {
    "_EMAIL_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_PHONE_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_CV_HINT_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_BUSINESS_CARD_HINT_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_NAME_LABEL_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_AFFILIATION_LABEL_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_ROLE_LABEL_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_AFFILIATION_LINE_HINT_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_ROLE_LINE_HINT_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_NON_NAME_HINT_PATTERN": "retired_person_file_copy_semantic_regex_symbol",
    "_normalise_person_name": "retired_person_file_copy_semantic_helper_symbol",
    "_looks_like_person_name": "retired_person_file_copy_semantic_helper_symbol",
    "_extract_emails": "retired_person_file_copy_semantic_helper_symbol",
    "_extract_phone_numbers": "retired_person_file_copy_semantic_helper_symbol",
    "_name_from_email": "retired_person_file_copy_semantic_helper_symbol",
    "_extract_candidate_names": "retired_person_file_copy_semantic_helper_symbol",
    "_extract_affiliations": "retired_person_file_copy_semantic_helper_symbol",
    "_extract_roles": "retired_person_file_copy_semantic_helper_symbol",
    "_infer_representation_mode": "retired_person_file_copy_semantic_helper_symbol",
}
COMPANY_FILE_COPY_RETIRED_SYMBOLS = {
    "_URL_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_COMPANY_LABEL_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_ABOUT_NAME_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_WEB_FILENAME_HINT_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_COMPANY_TEXT_HINT_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_COMPANY_SUFFIX_HINT_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_GENERIC_HEADER_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_NON_NAME_HINT_PATTERN": "retired_company_file_copy_semantic_regex_symbol",
    "_host_to_company_candidate": "retired_company_file_copy_semantic_helper_symbol",
    "_looks_like_company_name": "retired_company_file_copy_semantic_helper_symbol",
    "_extract_candidate_company_names": "retired_company_file_copy_semantic_helper_symbol",
    "_extract_descriptor_lines": "retired_company_file_copy_semantic_helper_symbol",
    "_infer_representation_mode": "retired_company_file_copy_semantic_helper_symbol",
}
MEETING_FILE_COPY_RETIRED_SYMBOLS = {
    "_MEETING_FILENAME_HINT_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_MEETING_TEXT_HINT_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_TRANSCRIPT_HINT_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_CALENDAR_HINT_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_MEETING_TITLE_LABEL_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_ATTENDEES_LABEL_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_ISO_DATETIME_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_HUMAN_DATE_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_SPEAKER_LINE_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_GENERIC_TITLE_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_NON_TITLE_HINT_PATTERN": "retired_meeting_file_copy_semantic_regex_symbol",
    "_looks_like_meeting_title": "retired_meeting_file_copy_semantic_helper_symbol",
    "_extract_meeting_titles": "retired_meeting_file_copy_semantic_helper_symbol",
    "_extract_datetime_candidates": "retired_meeting_file_copy_semantic_helper_symbol",
    "_looks_like_participant_name": "retired_meeting_file_copy_semantic_helper_symbol",
    "_extract_participants": "retired_meeting_file_copy_semantic_helper_symbol",
    "_extract_outcome_lines": "retired_meeting_file_copy_semantic_helper_symbol",
    "_infer_representation_mode": "retired_meeting_file_copy_semantic_helper_symbol",
}
...
CORE_SUPPORT_POLICY_CONTRACTS = (
    ...
    {
        "name": "person_file_copy_representation_authority_surface",
        "path": "src/backend/services/person_file_representation_service.py",
        "banned_symbol_names": PERSON_FILE_COPY_RETIRED_SYMBOLS,
    },
    {
        "name": "company_file_copy_representation_authority_surface",
        "path": "src/backend/services/company_file_representation_service.py",
        "banned_symbol_names": COMPANY_FILE_COPY_RETIRED_SYMBOLS,
    },
    {
        "name": "meeting_file_copy_representation_authority_surface",
        "path": "src/backend/services/meeting_file_representation_service.py",
        "banned_symbol_names": MEETING_FILE_COPY_RETIRED_SYMBOLS,
    },
    {
...
REPO_SEED_AUTHORITY_ALLOWED_PATHS = frozenset(
    {
        ...
        "src/backend/services/lab_status_digest_workflow_vontology_service.py",
        "src/backend/services/spreadsheet_programme_workflow_vontology_service.py",
        "src/backend/services/multilingual_concept_enrichment_vontology_service.py",
        "src/backend/services/operational_certification_vontology_service.py",
        "src/backend/services/operational_learning_release_authority_vontology_service.py",
        ...
        "src/backend/services/representation_workflow_routing_coverage_audit_vontology_service.py",
