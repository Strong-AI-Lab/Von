...
_NON_FORMAL_STAGE_SPECS: tuple[_StageSpec, ...] = (
    ...
    _StageSpec(
        stage_id="recovery_decision",
        stage_label="Recovery decision",
        order=105,
        stage_kind="non_formal",
        boundary_type="recovery_policy",
        stage_concept_id="#V#conversation_turn_stage_recovery_decision",
        workflow_id=CONVERSATION_TURN_EXECUTION_WORKFLOW_ID,
        workflow_state_id="recovery_decision",
        runtime_aliases=("recovery_decision",),
    ),
    _StageSpec(
        stage_id="recovery_retry_prepare",
        stage_label="Prepare recovery retry",
        order=107,
        stage_kind="non_formal",
        boundary_type="recovery",
        stage_concept_id="#V#conversation_turn_stage_recovery_retry_prepare",
        workflow_id=CONVERSATION_TURN_EXECUTION_WORKFLOW_ID,
        workflow_state_id="apply_recovery_retry",
    ...
    _StageSpec(
        ...
        stage_kind="non_formal",
        boundary_type="recovery",
        stage_concept_id="#V#conversation_turn_stage_recovery_follow_up_prepare",
        workflow_id=CONVERSATION_TURN_EXECUTION_WORKFLOW_ID,
        workflow_state_id="apply_recovery_follow_up",
        runtime_aliases=("apply_recovery_follow_up", "recovery_follow_up_prepare"),
    ),
    _StageSpec(
