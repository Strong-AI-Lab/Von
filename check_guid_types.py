...
code_en_nz = db["text_values"].count_documents(
    {"name_type": "CODE", "language": "en-NZ"}
)
print(f"  Count: {code_en_nz}")

code_en_nz_samples = (
    db["text_values"].find({"name_type": "CODE", "language": "en-NZ"}).limit(3)
)
...
code_vonguid = db["text_values"].count_documents(
    {"name_type": "CODE", "language": "vonGUID"}
)
