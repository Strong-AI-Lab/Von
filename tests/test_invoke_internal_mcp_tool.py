...
def test_internal_mcp_helper_applies_external_model_dotenv_override_keys():
    ...
    assert "OPENAI_API_BACKUP_KEY" in keys
    assert "OPENAI_API_BACKUP_KEY_FILE" in keys
    assert "VON_DEFAULT_OPENAI_MODEL" in keys
    assert "GEMINI_API_KEY" in keys
    assert "GEMINI_API_KEY_FILE" in keys
    assert "GEMINI_API_BACKUP_KEY" in keys
    assert "GEMINI_API_BACKUP_KEY_FILE" in keys
